  ...
  return (
    <section id="cta" className="pt-14 sm:pt-20 lg:pt-[130px]">
        <div className="px-4 mx-auto xl:container">
            ...
            >
            <div
                className="bg-noise-pattern absolute left-0 top-0 -z-10 h-full w-full bg-cover bg-center opacity-10 dark:opacity-40"
            ></div>
            ...
            <div className="-mx-4 flex flex-wrap items-center">
                ...
                >
                    <h2
                    className="font-heading text-dark mb-4 text-xl font-semibold leading-tight sm:text-[38px] dark:text-white"
                    >
