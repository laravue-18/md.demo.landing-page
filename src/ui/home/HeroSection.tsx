        ...
        <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-3 lg:w-1/2">
                <div className="mx-auto mb-12 max-w-[530px] text-center lg:mb-0 lg:ml-0 lg:text-left">
                    ...
                    <h1 className="font-heading mb-5 text-2xl font-semibold sm:text-4xl md:text-[50px] md:leading-[60px] dark:text-whtie">
                        ...
                        <TypeAnimation
                            sequence={[
                                ...
                                2000, // Waits 2s
                                'Agency', // Types 'Three' without deleting 'Two'
                                1000, // Waits 1s
                                'Startup', // Deletes 'Three' and types 'Four'
                                () => {
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-start">
                        <Link href="#features" className="bg-primary font-heading hover:bg-primary/90 inline-flex items-center rounded-sm px-6 py-[10px] text-base text-white md:px-8 md:py-[14px]">
                            Get Started
                            <span className="pl-3">
                        ...
                        <Link href="#about" className="font-heading text-dark hover:text-primary dark:hover:text-primary inline-flex items-center rounded-sm px-8 py-[14px] text-base dark:text-white">
                            <span className="pr-3">
            ...
            <div className="w-full px-4 lg:w-1/2">
                <div className="wow fadeInRight relative z-30 mx-auto h-[560px] w-full max-w-[700px] lg:ml-0">
                    <div className="absolute right-0 top-0 lg:w-11/12">
                        <Image src="/hero-img-01.png" alt="Hero" className="object-cover aspect-[1.08]" width={560} height={520} />
                    </div>
                    <div className="absolute bottom-0 left-0 z-10">
                        <Image src="/hero-img-02.jpeg" alt="Hero" className="object-cover" width={350} height={420} />
                        ...
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <radialGradient id="paint0_angular_300_926" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60 60) rotate(90) scale(60)">
                                    ...
                                    <stop offset="1" stopColor="#111722"></stop>
                                </radialGradient>
                            </defs>
                        </svg>
                    </div>
