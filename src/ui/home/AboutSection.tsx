    ...
    <section id="about" className="pt-14 sm:pt-20 lg:pt-[130px]">
        <div className="px-4 xl:container xl:mx-auto">
            ...
            <div className=" relative z-10 overflow-hidden rounded-sm px-8 pb-8 pt-0 md:px-[70px] md:pb-[70px] lg:px-[60px] lg:pb-[60px] xl:px-[70px] xl:pb-[70px]">
                ...
                <TabGroup>
                    <TabList className="tabButtons flex w-full items-center justify-around">
                        <Tab className="outline-none w-full border-b px-2 pb-6 pt-8 font-heading text-base font-medium lg:pb-7 lg:pt-9 data-hover:border-primary data-hover:text-primary data-selected:border-primary data-selected:text-primary dark:data-selected:border-primary">
                            About Us
                        </Tab>
                        <Tab className="outline-none w-full border-b px-2 pb-6 pt-8 font-heading text-base font-medium lg:pb-7 lg:pt-9 data-hover:border-primary data-hover:text-primary data-selected:border-primary data-selected:text-primary dark:data-selected:border-primary">
                            Our Mission
                    ...
                    <TabPanels className="w-full">
                        <TabPanel className="-mx-4 flex w-full flex-wrap items-center pt-[70px] ">
