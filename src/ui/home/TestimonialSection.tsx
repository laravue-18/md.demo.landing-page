                            ...
                            <div className="testimonial-item">
                                ...
                                <div className="order-last w-full px-4 lg:order-first lg:w-1/2">
                                    ...
                                    >
                                        ...
                                        adipiscing elit. Fusce condimentum sapien ac leo cursus
                                        dignissim. In ac lectus vel orci accumsan ultricies at
                                        in libero accumsan Lorem Ipsum has been the industry's
                                        standard
                                    </p>
                                    <h3
                                    ...
                                    <p className="text-dark-text text-base">Founder @ Pimjo</p>
                                    </div>
                                </div>
                                <div className="w-full px-4 lg:w-1/2">
                                    <div
                                    className="relative mx-auto mb-9 aspect-square w-full max-w-[420px] lg:mb-0 lg:mr-0"
                                    >
                                    ...
                                    <div
                                        className="border-primary/10 bg-primary/5 absolute -right-5 -top-5 -z-10 h-full w-full border backdrop-blur-[6px] dark:border-white/10 dark:bg-white/10"
                                    ></div>
        ...
        <div className="px-4 xl:container mx-auto">
            ...
            <div className="-mx-4 flex flex-wrap">
                ...
                <div className="flex flex-wrap items-center justify-center">
                    ...
                    >
                        <img alt="image" loading="lazy" width="180" height="40" decoding="async"
